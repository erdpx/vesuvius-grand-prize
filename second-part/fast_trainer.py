...
#folder_path = '/mnt/e/modelmain/training/training-in/'
...
for fid in fragments:
    ...
    wandb_logger = WandbLogger(project="letter",name='new',entity='new')
    norm=fold==1
